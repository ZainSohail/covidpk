...
class AddData extends Component {
    ...
    constructor(props) {
        ...
        firebase.auth().onAuthStateChanged( firebaseUser => {
            this.setState({
                'authenticated': (firebase.auth().currentUser == null ? false : true)
            });
        });
    }
    ...
    islHandleSubmit(event) {
        ...
        data.last_updated = this.state.recordDate;
    ...
    render() {
        ...
        if (error) {
          ...
          return (
            <div>
                <form methpd="post" onSubmit={this.islHandleSubmit}>
                    <button type="button" class="btn btn-primary mt-3 float-right" onClick={this.handleLogout}>Logout</button>
          ...
          return (
            <div>
                <form methpd="post" onSubmit={this.handleLogin}>
                    <div className="card mt-2">
                        <div className="card-body">
                            ...
                            <div className="row mt-4">
                                <div className="col-sm">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name="email" placeholder="Email" onChange={this.handleChange} required />
                                    </div>
                                    <div class="form-group">
