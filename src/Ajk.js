...
class Ajk extends Component {
  ...
  render() {
    ...
    if ( data !== null ) {
        ...
        var stats = data.countries.pakistan.provinces.ajk.stats,
        ...
        data.countries.pakistan.provinces.ajk.stats.forEach(function(item, index) {
...
export default Ajk; // Don’t forget to use export default!