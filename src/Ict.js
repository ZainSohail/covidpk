...
class Ict extends Component {
  ...
  render() {
    ...
    if ( data !== null ) {
        ...
        data.countries.pakistan.provinces.ict.stats.forEach(function(item, index) {
        ...
        <div className="col-12 col-md-6 mb-2">
            <div className="card">
               <div className="card-body">
                    <h3 className="card-title text-left text-uppercase">ISLAMABAD CAPITAL TERITORY</h3>
...
export default Ict; // Don’t forget to use export default!